...
from .text_clean import text_clean_pipeline
from .struct_clean import struct_clean_pipeline
...
def process_single_file(
    ...
    **kwargs
    ...
    :param process_func: 处理函数（base_clean_pipeline/text_clean_pipeline/struct_clean_pipeline
